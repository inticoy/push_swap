...
SRCS_SORT	= $(addprefix sort/,	pre_sort_2.c pre_sort_3.c pre_sort_4.c pre_sort_5.c pre_sort_6.c preprocess.c sort_five_nodes.c sort_four_nodes.c sort_stacks.c sort_three_nodes.c sort_two_nodes.c)
...
SRCS_MAIN	= main.c
SRCS = $(addprefix src/, $(SRCS_CMD) $(SRCS_DIV) $(SRCS_ERROR) $(SRCS_MATH) $(SRCS_MERGE) $(SRCS_ORDER) $(SRCS_SORT) $(SRCS_STACK) $(SRCS_UTIL) $(SRCS_MAIN))
